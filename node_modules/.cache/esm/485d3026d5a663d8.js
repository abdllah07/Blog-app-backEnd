let uuidv4,uploadPicture,fileRemover,Comment,UserArticle;_d5a‍.x([["getAllUserArticle",()=>getAllUserArticle],["getUserArticle",()=>getUserArticle],["deleteUserArticle",()=>deleteUserArticle],["createUserArticle",()=>createUserArticle],["updateUserArticle",()=>updateUserArticle]]);_d5a‍.w("uuid",[["v4",["uuidv4"],function(v){uuidv4=v}]]);_d5a‍.w("../middleware/uploadPictureMiddleware",[["uploadPicture",["uploadPicture"],function(v){uploadPicture=v}]]);_d5a‍.w("../utils/fileRemover",[["fileRemover",["fileRemover"],function(v){fileRemover=v}]]);_d5a‍.w("../models/Comment",[["default",["Comment"],function(v){Comment=v}]]);_d5a‍.w("../models/UserArticle",[["default",["UserArticle"],function(v){UserArticle=v}]]);
